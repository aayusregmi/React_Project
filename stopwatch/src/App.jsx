...
function App() {
  ...
  }, [isStartClick, isResetClick, isResetClick]);
    ...
    <>
      <div className='bg-black h-screen w-full flex justify-center items-center flex-col'>
        ...
        <div className='flex flex-wrap bg-gray-500 w-1/2 h-11 text-white rounded-xl my-2 flex-row justify-around items-center'>
          <button className='bg-green-600 rounded-md' onClick={start}>Start</button>
          <button className='bg-green-600 rounded-md' onClick={stop}>Stop</button>
          <button className='bg-green-600 rounded-md' onClick={reset}>Reset</button>
        </div>
      </div>
    </>
  )
